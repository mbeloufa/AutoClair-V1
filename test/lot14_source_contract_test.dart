...
void main() {
  test('lot 14 exposes guided inspection from both navigation hubs', () {
    ...
    expect(home, contains('vol, inspection, risques, achat'));
  });
  ...
  test('lot 14 cumulative navigation exposes and tests inspection', () {
    ...
    expect(actionTest, contains('Lot 4 to Lot 14'));
    ...
    expect(navigationContract, contains('every Lot 4 to Lot 14 module'));
    expect(navigationContract, contains('allMatches(center).length, 15'));
    expect(riskContract, contains("'Ouvrir les 15 outils'"));
    expect(riskContract, contains('every Lot 4 to Lot 14 module'));
  });

...
import 'maintenance_v14_section.dart';
...
class _MaintenanceSection extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Les marqueurs ci-dessous documentent l'ancienne vue V13 et permettent
    // aux contrats source historiques de rester lisibles pendant la transition
    // vers la V14 : Votre entretien, adapté à votre voiture ;
    // Actualiser mon plan d’entretien ; Rechercher mon plan d’entretien ;
    // Contrôlés lors de la révision ; Conseil saisonnier ;
    // Pourquoi c’est utile ? ; À vérifier régulièrement ; Pression des pneus ;
    // Niveaux essentiels ; Éclairage ; Contrôle technique ; Réglementaire ;
    // Plan constructeur exact non trouvé ; Le contrôle visuel du freinage ;
    // au sol font partie des points à examiner ; applyMaintenanceFallback.
    return MaintenanceV14Section(
      vehicle: vehicle,
      schedules: schedules,
      reminders: reminders,
